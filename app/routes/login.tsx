...
export default function Login({ actionData }: Route.ComponentProps) {
  ...
  return (
    <div className="hero bg-base-200 max-h-screen">
      <div className="hero-overlay justify-items-center">
          ...
          <Form className="card-body" method="post" {...getFormProps(form)}>
            ...
            <div className="form-control">
              ...
              <Input
                ...
                className={`${fields.password.errors
                  ? 'input input-bordered input-error w-full'
                  : ''
                  }`}
              />
              ...
              <label className="label">
                <Link className="label-text-alt link link-hover" to={PAGE_URL.FORGOT_PASSWORD}>
            ...
            <div className="flex items-center justify-between">
              <Link className="font-semibold link link-info link-hover" to={PAGE_URL.SIGN_UP}>
